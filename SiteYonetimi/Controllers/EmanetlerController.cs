...
namespace SiteYonetimi.Controllers
{
    public class EmanetlerController : Controller
    {
        ...
        [HttpPost]
        public ActionResult OduncVer(TBL_hareket2 p)
        {
            ...
            p.TBL_KITAP = d2;
            p.TBL_PERSONEL = d3;
            db.TBL_hareket2.Add(p);
            db.SaveChanges();
            return RedirectToAction("Index");

        }
        public ActionResult Odunciade(TBL_hareket2 p)
        {
            var odn = db.TBL_hareket2.Find(p.ID);
        ...
        public ActionResult OduncGuncelle(TBL_hareket2 p)
        {
